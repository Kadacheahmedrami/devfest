...
const Signup = () => {
  ...
  return (
    <>
      <div className="flex w-full justify-center m-auto h-[650px] md:w-[594px] p-[55px_41px] flex-col items-center gap-10 rounded-[35px] bg-white shadow-[0px_4px_16px_3px_rgba(37,27,228,0.20)]">
